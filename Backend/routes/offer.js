...
router.post('/add', auth.authenticateToken, checkRole.checkRole, (req, res) => {
    ...
    var query = "INSERT INTO offer (typeOffer,descriptionOffer,addressOffer,timeOffer,photoOffer) VALUES (?,?,?,?,?)";
    connection.query(query, [offer.typeOffer, offer.description, offer.address, offer.time, offer.photo], (err, results) => {
        if (!err) {
...
// Function to register a new user in the fb, returning a response with the corresponding status type
router.get('/getAllOffer', auth.authenticateToken, (req, res) => {
